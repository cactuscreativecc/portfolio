                ...
                <div ref={headlineRef} className="z-[100] text-center w-full max-w-5xl px-6 pointer-events-none">
                    <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 mb-8 mx-auto">
                        ...
                        <span className="text-[10px] font-black tracking-[0.3em] text-neutral-400 uppercase leading-none">
                            {t.CaseStudies?.label || "PROJETOS SELECIONADOS"}
                        </span>
                    </div>
                    <h2
                        className="font-headline text-5xl md:text-7xl 2xl:text-8xl font-black tracking-tighter uppercase text-white leading-none whitespace-pre-line"
